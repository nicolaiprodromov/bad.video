...
// var test = document.getElementById('particles')
// var ta = new TextAnim(test)

// ta.nr_vo_out(400, 'easeInOutCirc', 15)
// ta.cycle_random(1000, 100)
// setTimeout(() => {ta.simCharacters()}, 1100);


// var test1 = document.getElementById('particles1')
// var ta1 = new TextAnim(test1)

// ta1.nr_vo_out(400, 'easeInOutCirc', 15)
// ta1.cycle_random(1000, 100)
// setTimeout(() => {ta1.simCharacters()}, 1100);



// ta.element.addEventListener('mouseenter', (e) => {
//     ta.nr_vo_in(200, 'easeInOutCirc', 15)
// })
// ta.element.addEventListener('mouseleave', (e) => {
//     ta.nr_vo_out(200, 'easeInOutCirc', 15)
//     //ta.update(ta.text)
// })



// ta.element.addEventListener('mouseover', (e) => {
//     ta.mouse_mix_text(e, 150, "marcois PROSTOdic")
// })